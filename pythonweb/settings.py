...
SECRET_KEY = '9ali&0(3le^xd!-&3nq41_^4^_#ou$1046)i9l3#=r#6441j$3'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',  # oracle,mysql
        'NAME': 'test',
        'USER': 'test',
        'PASSWORD': 'yujian123',
        'HOST': '127.0.0.1',
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'my-project/dist/static/'),  # 添加内容
